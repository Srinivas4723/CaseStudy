...
public interface ReaderRepository extends JpaRepository<Reader, Long> {
	...
	List<Reader> findByReadernameAndReaderemail(String readername,String readeremail);
	Boolean existsByreadername(String readername);
	boolean existsByreaderemail(String readeremail);
	List<Reader> findByReadernameOrReaderemail(String readername, String readeremail);
